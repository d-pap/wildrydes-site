!(function (e, t) {
    ...
    if (void 0 === n && 1 === e.nodeType)
      if (((r = "data-" + t.replace(Pe, "-$&").toLowerCase()), (n = e.getAttribute(r)), "string" == typeof n)) {
        try {
          n =
            "true" === n ||
            ("false" !== n && ("null" === n ? null : +n + "" === n ? +n : Oe.test(n) ? JSON.parse(n) : n))
        } catch (i) {}
        Fe.set(e, t, n)
      } else n = void 0
    return n
    ...
    for (var n, r, i = [], o = 0, a = e.length; o < a; o++)
      (r = e[o]),
        r.style &&
          ((n = r.style.display),
          t
            ? ("none" === n && ((i[o] = He.get(r, "display") || null), i[o] || (r.style.display = "")),
  ...
  function D(e, t, r, i) {
    ...
    if (
      p &&
      ((o = y(t, e[0].ownerDocument, !1, e, i)), (a = o.firstChild), 1 === o.childNodes.length && (o = a), a || i)
    ) {
      for (s = pe.map(m(o, "script"), k), u = s.length; f < p; f++)
        (l = o), f !== d && ((l = pe.clone(l, !0, !0)), u && pe.merge(s, m(l, "script"))), r.call(e[f], l, f)
      if (u)
        for (c = s[s.length - 1].ownerDocument, pe.map(s, E), f = 0; f < u; f++)
          (l = s[f]),
            Xe.test(l.type || "") &&
              ...
              pe.contains(c, l) &&
              (l.src ? pe._evalUrl && pe._evalUrl(l.src) : n(l.textContent.replace(nt, ""), c))
    }
    return e
  }
  function j(e, t, n) {
    for (var r, i = t ? pe.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
      n || 1 !== r.nodeType || pe.cleanData(m(r)),
        r.parentNode && (n && pe.contains(r.ownerDocument, r) && v(m(r, "script")), r.parentNode.removeChild(r))
    return e
  }
  function A(e, t, n) {
    var r,
  ...
  function L(e) {
    if (e in ct) return e
    for (var t = e[0].toUpperCase() + e.slice(1), n = lt.length; n--; ) if (((e = lt[n] + t), e in ct)) return e
  }
  function H(e, t, n) {
    var r = Me.exec(t)
      ...
      "margin" === n && (a += pe.css(e, n + Ie[o], !0, i)),
        r
          ? ("content" === n && (a -= pe.css(e, "padding" + Ie[o], !0, i)),
            "margin" !== n && (a -= pe.css(e, "border" + Ie[o] + "Width", !0, i)))
  ...
  function $(e, t, n) {
    ...
    if (((u = !pe.isEmptyObject(t)), u || !pe.isEmptyObject(d))) {
      f &&
        ...
        (c = pe.css(e, "display")),
        "none" === c && (l ? (c = l) : (g([e], !0), (l = e.style.display || l), (c = pe.css(e, "display")), g([e]))),
              ...
              (n = a[t]),
                ...
                a !== r &&
                  (l && r && (pe.isPlainObject(r) || (i = pe.isArray(r)))
                    ? (i ? ((i = !1), (o = n && pe.isArray(n) ? n : [])) : (o = n && pe.isPlainObject(n) ? n : {}),
                      (a[t] = pe.extend(l, o, r)))
                    : void 0 !== r && (a[t] = r))
        return a
      }),
    pe.extend({
      ...
      isPlainObject: function (e) {
        ...
        return (
          ...
          (!(t = ee(e)) ||
            ((n = se.call(t, "constructor") && t.constructor), "function" == typeof n && ue.call(n) === le))
        )
      },
      ...
      each: function (e, t) {
        var n,
          i = 0
        if (r(e)) for (n = e.length; i < n && t.call(e[i], i, e[i]) !== !1; i++);
      ...
      map: function (e, t, n) {
        var i,
          ...
          a = 0,
          s = []
        if (r(e)) for (i = e.length; a < i; a++) (o = t(e[a], a, n)), null != o && s.push(o)
      ...
      proxy: function (e, t) {
        var n, r, i
        if (("string" == typeof t && ((n = e[t]), (t = e), (e = n)), pe.isFunction(e)))
          return (
      ...
      if (!r && ((t ? t.ownerDocument || t : $) !== H && L(t), (t = t || H), O)) {
        ...
        if (T.qsa && !U[e + " "] && (!P || !P.test(e))) {
          if (1 !== h) (p = t), (c = e)
            ...
            for (
              (s = t.getAttribute("id")) ? (s = s.replace(we, Te)) : t.setAttribute("id", (s = W)),
                l = S(e),
                o = l.length;
              o--;
    ...
    function l(e) {
      return function (t) {
        return (
          ...
          ("form" in t &&
            t.disabled === !1 &&
            (t.isDisabled === e || (t.isDisabled !== !e && ("label" in t || !ke(t)) !== e)))
        )
      }
    }
    function c(e) {
                      ...
                      if (((h = [a ? m.firstChild : m.lastChild]), a && y)) {
                        ...
                        for (
                          ...
                          ((s ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) ||
                            !++x ||
                            (y &&
                              ((f = p[W] || (p[W] = {})), (c = f[p.uniqueID] || (f[p.uniqueID] = {})), (c[e] = [B, x])),
                            p !== t));
        ...
        function (e, t, n, r) {
          ...
          if (((n = n || []), 1 === c.length)) {
            ...
            for (i = de.needsContext.test(e) ? 0 : o.length; i-- && ((a = o[i]), !C.relative[(s = a.type)]); )
              if (
                (u = C.find[s]) &&
                (r = u(a.matches[0].replace(xe, be), (ye.test(o[0].type) && f(t.parentNode)) || t))
              ) {
  ...
  var Ce,
    ...
    Ee = (pe.fn.init = function (e, t, n) {
      ...
      if (((n = n || Ce), "string" == typeof e)) {
        if (
          ((r = "<" === e[0] && ">" === e[e.length - 1] && e.length >= 3 ? [null, e, null] : ke.exec(e)),
          !r || (!r[1] && t))
        )
      ...
      function (e, t) {
        pe.fn[e] = function (n, r) {
          ...
          return (
            ...
            this.length > 1 && (Ne[e] || pe.uniqueSort(i), Se.test(e) && i.reverse()),
            this.pushStack(i)
          )
        }
      }
  ...
  ;(pe.Callbacks = function (e) {
    ...
    pe.extend({
                        ...
                        ;(f = e && ("object" == typeof e || "function" == typeof e) && e.then),
                          pe.isFunction(f)
                            ? i
                              ...
                              : (a++, f.call(e, o(a, n, s, i), o(a, n, u, i), o(a, n, s, n.notifyWith)))
                            : (r !== s && ((l = void 0), (c = [e])), (i || n.resolveWith)(l, c))
                      }
                    },
                    p = i
                      ? f
      ...
      when: function (e) {
        ...
        if (
          t <= 1 &&
          (l(e, o.done(a(n)).resolve, o.reject), "pending" === o.state() || pe.isFunction(i[n] && i[n].then))
        )
          return o.then()
    ...
    pe.extend({
      ...
      ready: function (e) {
        ;(e === !0 ? --pe.readyWait : pe.isReady) ||
          ((pe.isReady = !0), (e !== !0 && --pe.readyWait > 0) || Ae.resolveWith(Z, [pe]))
      },
    }),
    (pe.ready.then = Ae.then),
    "complete" === Z.readyState || ("loading" !== Z.readyState && !Z.documentElement.doScroll)
      ? e.setTimeout(pe.ready)
      : (Z.addEventListener("DOMContentLoaded", c), e.addEventListener("load", c))
  ...
  ;(f.uid = 1),
    (f.prototype = {
      ...
      remove: function (e, t) {
        ...
        if (void 0 !== r) {
          if (void 0 !== t) {
            pe.isArray(t) ? (t = t.map(pe.camelCase)) : ((t = pe.camelCase(t)), (t = t in r ? [t] : t.match(De) || [])),
              (n = t.length)
            for (; n--; ) delete r[t[n]]
          }
      ...
      data: function (e, t) {
        ...
        if (void 0 === e) {
          if (this.length && ((i = Fe.get(o)), 1 === o.nodeType && !He.get(o, "hasDataAttrs"))) {
            for (n = a.length; n--; )
              a[n] && ((r = a[n].name), 0 === r.indexOf("data-") && ((r = pe.camelCase(r.slice(5))), p(o, r, i[r])))
    ...
    pe.fn.extend({
      ...
      promise: function (e, t) {
        ...
        for ("string" != typeof e && ((t = e), (e = void 0)), e = e || "fx"; a--; )
          (n = He.get(o[a], e + "queueHooks")), n && n.empty && (r++, n.empty.add(s))
    ...
    We = function (e, t) {
      return (
        ...
        "none" === e.style.display ||
          ("" === e.style.display && pe.contains(e.ownerDocument, e) && "none" === pe.css(e, "display"))
      )
    },
    $e = function (e, t, n, r) {
      var i,
  ...
  ;(pe.event = {
        ...
        for (
          n.handler && ((o = n), (n = o.handler), (i = o.selector)),
            ...
            (a = m.handle) ||
              (a = m.handle =
                function (t) {
                  return "undefined" != typeof pe && pe.event.triggered !== t.type
      ...
      if (m && (u = m.events)) {
        for (t = (t || "").match(De) || [""], l = t.length; l--; )
          if (((s = Je.exec(t[l]) || []), (d = g = s[1]), (h = (s[2] || "").split(".").sort()), d)) {
            ...
            a &&
              !p.length &&
              ((f.teardown && f.teardown.call(e, h, m.handle) !== !1) || pe.removeEvent(e, d, m.handle), delete u[d])
    ...
    dispatch: function (e) {
      ...
      if (((s.delegateTarget = this), !c.preDispatch || c.preDispatch.call(this, s) !== !1)) {
        for (a = pe.event.handlers.call(this, s, l), t = 0; (i = a[t++]) && !s.isPropagationStopped(); )
        ...
        ? (e && e.type
            ? ((this.originalEvent = e),
              ...
              (this.isDefaultPrevented =
                e.defaultPrevented || (void 0 === e.defaultPrevented && e.returnValue === !1) ? x : b),
  ...
  pe.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (t)
        if (n) for (o = o || m(e), a = a || m(s), r = 0, i = o.length; r < i; r++) S(o[r], a[r])
        else S(e, s)
      ...
      function (e, t) {
        pe.fn[e] = function (e) {
          for (var n, r = [], i = pe(e), o = i.length - 1, a = 0; a <= o; a++)
            (n = a === o ? this : this.clone(!0)), pe(i[a])[t](n), re.apply(r, n.get())
  ...
  pe.extend({
    ...
    pe.each(["height", "width"], function (e, t) {
      pe.cssHooks[t] = {
        get: function (e, n, r) {
          if (n)
            return !at.test(pe.css(e, "display")) || (e.getClientRects().length && e.getBoundingClientRect().width)
              ? O(e, t, r)
              : $e(e, st, function () {
                  return O(e, t, r)
                })
  ...
  ;(pe.Animation = pe.extend(_, {
    ...
    tweener: function (e, t) {
      ...
      for (var n, r = 0, i = e.length; r < i; r++)
        (n = e[r]), (_.tweeners[n] = _.tweeners[n] || []), _.tweeners[n].unshift(t)
    },
    prefilters: [$],
      ...
      attr: function (e, t, n) {
        ...
        if (3 !== o && 8 !== o && 2 !== o)
          return "undefined" == typeof e.getAttribute
            ? pe.prop(e, t, n)
            : ((1 === o && pe.isXMLDoc(e)) ||
                (i = pe.attrHooks[t.toLowerCase()] || (pe.expr.match.bool.test(t) ? gt : void 0)),
              void 0 !== n
                ? null === n
        ...
        : this.each(function () {
            ...
            if ("string" === n)
              ...
              (void 0 !== e && "boolean" !== n) ||
                ...
                this.setAttribute &&
                  this.setAttribute("class", t || e === !1 ? "" : He.get(this, "__className__") || ""))
          })
    },
    hasClass: function (e) {
      var t,
        ...
        if (i)
          return (
            ...
            t && "get" in t && void 0 !== (n = t.get(i, "value"))
              ? n
              : ((n = i.value), "string" == typeof n ? n.replace(bt, "") : null == n ? "" : n)
          )
      }
    },
  }),
        ...
        select: {
          ...
          set: function (e, t) {
            for (var n, r, i = e.options, o = pe.makeArray(t), a = i.length; a--; )
              (r = i[a]), (r.selected = pe.inArray(pe.valHooks.option.get(r), o) > -1) && (n = !0)
      ...
      if (
        ...
        for (o = 0; (a = p[o++]) && !t.isPropagationStopped(); )
          (t.type = o > 1 ? u : f.bindType || d),
            ...
            c && c.apply(a, n),
            (c = l && a[l]),
            c && c.apply && Le(a) && ((t.result = c.apply(a, n)), t.result === !1 && t.preventDefault())
        return (
          (t.type = d),
          i ||
      ...
      ajax: function (t, n) {
        function r(t, n, r, s) {
          ...
          c ||
            ...
            y.fireWith(g, [C, T]),
            f && (m.trigger("ajaxComplete", [C, h]), --pe.active || pe.event.trigger("ajaxStop")))
        }
        ...
        ;(f = pe.event && h.global),
          ...
          h.hasContent
            ...
            : ((d = h.url.slice(o.length)),
              h.data && ((o += (Et.test(o) ? "&" : "?") + h.data), delete h.data),
              h.cache === !1 && ((o = o.replace(Lt, "")), (d = (Et.test(o) ? "&" : "?") + "_=" + kt++ + d)),
              (h.url = o + d)),
          h.ifModified &&
            (pe.lastModified[o] && C.setRequestHeader("If-Modified-Since", pe.lastModified[o]),
  ...
  pe.ajaxSetup({
      ...
      if (s || "jsonp" === t.dataTypes[0])
        return (
          ...
          s
            ...
            : t.jsonp !== !1 && (t.url += (Et.test(t.url) ? "&" : "?") + t.jsonp + "=" + i),
    ...
    (pe.parseHTML = function (e, t, n) {
      ...
      return (
        ...
        (i = we.exec(e)),
        (o = !n && []),
        i ? [t.createElement(i[1])] : ((i = y([e], t, o)), o && o.length && pe(o).remove(), pe.merge([], i.childNodes))
      )
    }),
            ...
            ? ((r = o.getBoundingClientRect()),
              r.width || r.height
                ? ((i = o.ownerDocument),
                  (n = J(i)),
                  (t = i.documentElement),
                  { top: r.top + n.pageYOffset - t.clientTop, left: r.left + n.pageXOffset - t.clientLeft })
                : r)
            : { top: 0, left: 0 }
      },
      position: function () {
        if (this[0]) {
          ...
          return (
            ...
            { top: t.top - r.top - pe.css(n, "marginTop", !0), left: t.left - r.left - pe.css(n, "marginLeft", !0) }
          )
        }
      },
